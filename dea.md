...
2. Europeana has, for this purpose, undertaken the task of ingesting, indexing, enriching and making available descriptive metadata, previews and objects that are part of that heritage,
3. Europeana thereby intends to benefit both the holders of these objects and the public at large;
4. For this purpose Europeana maintains a database that includes Metadata, Previews and Content;
5. the Data Partner has and/or can create Metadata and Previews that are appropriate to form part of this database;
6. the Data Partner is willing to make (a part of) these Metadata and Previews available for this database, under the conditions of this agreement;
...
1. Notwithstanding paragraphs 2 and 3 of this article, Europeana is entitled to allow use of the Previews by visitors of Europeana.eu and Third Parties in accordance with terms specified by the Data Partner in the europeana:rights field (or its equivalent in a later version) of the Metadata Specifications.   
2. Europeana is entitled to store and publish on Europeana.eu all Previews provided by the Data Partner, though only in combination with the Metadata that pertain to the same Content.
3. Europeana is entitled to use Previews and Content referenced in accordance with the conditions established by the rights statement contained in the Metadata associated with the Preview and/or Content.
4. In as far as the Data Partner is the proprietor of Intellectual Property Rights to the Previews it provides to Europeana, the Data Partner hereby grants Europeana a license to use these rights in accordance with this article, without affecting any moral rights that it may have in these Previews. 
5. In as far as the Data Partner has provided or will provide Europeana with Previews that it has aggregated from Third Parties or that otherwise originate from Third Parties, the Data Partner ensures that these Third Parties have authorized the Data Partner to enable Europeana to perform paragraphs 1 and 2 of this article.

## Article 5 Liability and Notice and take Down
...
3. Upon termination of this agreement, Europeana shall only be obliged to remove Metadata and Previews provided by the Data Partner if the Data Partner request Europeana to remove the Metadata and Previews. Removal shall happen no later than 30 days after such a request has been received by Europeana.
...
6. The Agreement shall end on the 31st December following the Effective Date. The Agreement will be renewed automatically for a period of one year every 1st January, unless terminated by one of the parties, by written notice received by the other party ultimately on 30 September of that year.
